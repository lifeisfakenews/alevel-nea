    ...
    return (
        <ParallaxScrollView
            ...
            <ThemedView>
                ...
                <TextInput value={username} onChangeText={setUsername} style={{ backgroundColor: "#555", borderRadius: 10, color: "#ffffff", fontSize: 18 }} autoComplete="username" textContentType="username" />

                <ThemedText type="subtitle">Password</ThemedText>
                <TextInput value={password} onChangeText={setPassword} secureTextEntry={true} style={{ backgroundColor: "#555", borderRadius: 10, color: "#ffffff", fontSize: 18 }} autoComplete="password" textContentType="password" />
